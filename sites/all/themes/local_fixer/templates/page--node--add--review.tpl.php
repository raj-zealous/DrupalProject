...
<div class="wrapper">
  ...
  <div class="content-wrapper write_review_page">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <?php if ($messages): ?>
          ...
          <div class="profile-info-box clearfix">
            ...
            <span><?php print format_date(time(), "custom", "F j, Y") ?></span>
          </div>
          <div class="info-text">Have your say! Write a review and share it with the world.</span></div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-5">
            ...
            <div class="signup-form" id="optionsForm">
              ...
              <div class="form-field-box">
                <?php print drupal_render($form['field_review_name_of_est']); ?>
              </div>

              <div class="form-field-box">
                <?php print drupal_render($form['field_review_location']); ?>                
              </div>

              <div class="form-field-box clearfix">
                <?php print drupal_render($form['field_review_ratings']); ?>
              </div>


              <div class="share-form-box clearfix">
                <div class="file-upload">
                  <label>Upload images <span>(max of 5 photos)</span></label>
                  <?php print drupal_render($form['field_review_images']); ?>
                </div>
              ...
              <div class="form-field-box">
                <div class="share-form-box clearfix">
                  ...
                  <?php print drupal_render($form['field_review_description']); ?>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-7">
            <div class="col-sm-12">
              <div class="form-field-box">                
                <label>Select Review Category</label>
                <?php print drupal_render($form['field_reivew_interest']); ?>
                <ul id="interest_user"></ul>
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <div class="review-box">
                <div class="form-field-box">
                  ...
                  <?php print drupal_render($form['field_review_type']); ?>                  
                </div>
