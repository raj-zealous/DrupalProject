...
if (!empty($args[0]) && $args[0] == 'written-reviews' && !empty($args[1])) {
  if ($args[1] == $user->uid) {
    $uid = $args[1];
    $other_user_profile = 0;
  } else {
            ...
            <div class="profile-leftside clearfix">
              <div class="profile-leftnav">
                <ul>
                  ...
                  <li class="active"><a href="<?php print $base_url . "/written-reviews/" . $uid ?>"><img src="<?php print $path; ?>/images/written-reviews-icon.png" alt=""/></a></li>
            ...
            <div class="profile-rgt-box">
              ...
              <div id="horizontalTab">
                <ul class="resp-tabs-list">
                  <li>Local Secrets</li>
                  <li>Traveller Experience</li>
                  <li>Both</li>
                </ul>
                <div class="resp-tabs-container">
                  <div class="write-review-box">
                    <?php
                    $block = module_invoke('views', 'block_view', 'available_accommodation-block_1');
                    print render($block['content']);
                    ?>
                  </div>
                  <div class="write-review-box">
                    <?php
                    $block = module_invoke('views', 'block_view', 'available_accommodation-block_2');
                    print render($block['content']);
                    ?>
                  </div>
                  <div class="write-review-box">
