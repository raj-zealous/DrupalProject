            ...
            <div class="row clearfix">
              <div class="col-sm-9 search-filter-box">
                <div class="view-buttons">
                  <div class="list-button active"><a href="/search-reviews"><span></span>LIST</a></div>
                  <div class="map-button"><a href="/map"><span></span>Map</a></div>
                </div>


                <div class="search-filter-form">
                  <?php
                  $block = module_invoke('views', 'block_view', '-exp-search_reviews-page_1');
