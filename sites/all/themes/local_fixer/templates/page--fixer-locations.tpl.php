...
<div class="wrapper">
  ...
  <section id="location-page-content" class="">

    <div class="container">
      <div class="row clearfix">
        <div class="co1-sm-12 text-center">
          <h1 class="page-title"><?php print $title; ?></h1>
          <a id="main-content"></a> <?php print $messages; ?>
          <?php if (!empty($tabs)): ?>
    ...
    <div class="location-top-box text-center">
      <div class="container">
        <div class="row clearfix">
          <div class="co1-sm-12 text-center">
            <div class="contact-icon-top"><img src="<?php print $path; ?>/images/location-icon.png" class="img-responsive"></div>
            <div class="contact-text1 clearfix">Our community is growing and is currently availble in the following cities...</div>
          </div>
        </div>
      </div>
          ...
          <div class="row clearfix">
            <div class="location-list clearfix">
              ...
              foreach ($cities as $city) {
                if ($counter == 1) {
                  $output.= '<div class="col-sm-2"><ul>';
                }
                $output.= '<li><a href="' . $base_url . '/search-reviews?field_review_location_locality=' . $city . '">' . $city . '</a></li>';
                $counter++;
                if ($counter == 6) {
                  $counter = 1;
                  $output.= '</ul></div>';
        ...
        <div class="contact-form-section2">
          ...
          if (user_is_logged_in()) {
            ...
            <div class="sharing-btn">
              <button class="btn-orange" onclick="window.location = '<?php print $base_url . '/node/add/review' ?>'" type="submit">Start Sharing!</button>
            </div>
            <?php
          } else {
            ?>
            <div class="sharing-btn">
              <button class="btn-orange" onclick="document.getElementById('register_link').click();" type="submit">Start Sharing!</button>
            </div>
            <?php
          }
          ?>
