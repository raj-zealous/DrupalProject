  ...
  <div class="pro-review-box clearfix">
    ...
    <div class="review-right-data">
      ...
      <div class="preview-location review">
        <div class="location-text"><strong>Location:</strong> 
          <?php print render($field_review_street_no_value); ?>
          <?php print render($field_review_street_value) . ", "; ?>
          <?php print render($field_review_city_value); ?>
          <?php print render($field_review_state_value); ?>
          <?php print render($field_review_country_value); ?>
