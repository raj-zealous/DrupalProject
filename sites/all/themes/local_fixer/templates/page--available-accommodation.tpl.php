...
if (!empty($args[0]) && $args[0] == 'available-accommodation' && !empty($args[1])) {
    if ($args[1] == $user->uid) {
        $uid = $args[1];
        $other_user_profile = 0;
    } else {
                        ...
                        <div class="profile-leftside clearfix">
                            <div class="profile-leftnav">
                                <ul>
                                    ...
                                    <li class="active"><a href="<?php print $base_url . "/available-accommodation/" . $uid ?>"><img src="<?php print $path; ?>/images/avl-acc-icon.png" alt=""/></a></li>
