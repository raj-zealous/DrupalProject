...
if (!empty($args[0]) && $args[0] == 'accommodation' && !empty($args[1])) {
    if ($args[1] == $user->uid) {
        $uid = $args[1];
        $other_user_profile = 0;
    } else {
...
foreach ($field_interests_field as $value) {
    ...
    $name = $term->name;
    $items[] = array(
        'data' => '<a href="javascript:void(0)">' . $name . '</a>',
...
<div class="wrapper">
    ...
    <section id="container-top-bar" class="content-top-bar">
        <div class="container">
            <div class="row">
                        ...
                        <div class="profile-leftside clearfix">
                            <div class="profile-leftnav">
                                <ul>
                                    ...
                                    <li><a href="#"><img src="<?php print $path; ?>/images/written-reviews-icon.png" alt=""/></a></li>
                                    <li><a href="<?php print $base_url . "/accommodation/" . $uid ?>"><img src="<?php print $path; ?>/images/avl-acc-icon.png" alt=""/></a></li>
                                    <li class="active"><a href="<?php print $base_url . "/items/" . $uid ?>"><img src="<?php print $path; ?>/images/item-share-icon.png" alt=""/></a></li>
                                    <li><a href="#"><img src="<?php print $path; ?>/images/save-reviews-icon.png" alt=""/></a></li>
                                </ul>
                            </div>
                            <div class="user-profile-box">
                                ...
                                <div class="user-rating-box">
                                    ...
                                    <button class="send-msg" onclick="window.location.href = '<?php print $base_url ?>/send_message_to_friend/add'"><span>Send Message</span></button>                       </div>
                                ...
                                <div class="share-profile-box clearfix">
                                    ...
                                    <ul>
                                        <li><a href="#" class="pf-twitter"></a></li>
                                        <li><a href="#" class="pf-fb"></a></li>
                                        <li><a href="#" class="pf-gplus"></a></li>
                                        <li><a href="#" class="pf-mail"></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
