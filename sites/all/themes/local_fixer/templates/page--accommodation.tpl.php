                        ...
                        <div class="profile-leftside clearfix">
                            <div class="profile-leftnav">
                                <ul>
                                    ...
                                    <li class="active"><a href="<?php print $base_url . "/accommodation/" . $uid ?>"><img src="<?php print $path; ?>/images/avl-acc-icon.png" alt=""/></a></li>
                                    <li><a href="<?php print $base_url . "/items/" . $uid ?>"><img src="<?php print $path; ?>/images/item-share-icon.png" alt=""/></a></li>
